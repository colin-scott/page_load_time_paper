...
Our goal for the rest of the paper is to gain a deeper understanding of the
performance dynamics outlined in the previous section. To do so
 we need to experimentally evaluate, in a
controlled manner,
