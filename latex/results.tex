...
our CPU constrained VM (`Desktop Constrained - 1 GHz CPU') behaves very
similarly to our tablet (`Mobile'), while our RAM constrained VM (`Desktop Constrained - 1 GB RAM') is more closely aligned with the `Desktop' results.
