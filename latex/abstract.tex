...
We argue that there are two causes for this weak improvement:
objects on the critical path are often are not cached, and
slow processors on mobile devices mean that computational delays dominate
network delays.
...
to include mobile devices with slow CPUs, and manage to reproduce the
HTTP proxy caching
...
We develop a back-of-envelope performance model to help understand these
effects.
