...
objects on the critical path are often not cached, and the limited computational power of mobile devices causes computational delays to dominate network delays. %and this effect is amplified by a low rate of cache hits for objects on the critical path.
