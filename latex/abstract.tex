...
slow mobile devices cause computational delays to dominate network delays. %and this effect is amplified by a low rate of cache hits for objects on the critical path.
