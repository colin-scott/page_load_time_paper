...
%
% Limitations of WProf:
%   the critical path are cached.
%   - Fig 13 Does not have a line for C=2
%   - Fig 13 is for a single freakin' URL. And, across URLs, those what-if
%   graphs are pretty freakin' crazy (high variance, even crazy things like
%   increased PLT after faster n or c)
