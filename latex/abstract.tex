...
We argue that there are main two causes for this weak improvement:
objects on the critical path are often not cached (cacheable), and
slow mobile CPUs make computational delays dominate network delays. %and this effect is amplified by a low rate of cache hits for objects on the critical path.
