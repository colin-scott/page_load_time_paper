...
and computational times by examining the task dependencies for the
web page (captured with WProf), and recomputing the critical path to determine a predicated PLT. The
comp=1 line represents the (2 GHz) desktop CPU that loaded the original page, while comp=0
