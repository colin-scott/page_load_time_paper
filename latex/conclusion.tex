...
effects of caching for the mobile web of the future.%\\[0.5ex]
...
performance model.
%We also thank the EECS network administrators for tolerating
%our sometimes-questionable web traffic.
